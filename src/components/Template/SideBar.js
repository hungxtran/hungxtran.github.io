...
const SideBar = () => (
  <section id="sidebar">
    <section id="intro">
      ...
      <header>
        <h2>Hung X. Tran</h2>
        <p><a href="mailto:contact@hungxtran.com">contact@hungxtran.com</a></p>
      </header>
    </section>

    <section className="blurb">
      <h2>About</h2>
      <p>Hi, I&apos;m Hung. I am a <a href="https://icme.stanford.edu/">Stanford ICME</a> graduate, YC Alumni,
    ...
    <section id="footer">
      <ContactIcons />
      <p className="copyright">&copy; Hung X. Tran <Link to="/">hungxtran.com</Link>.</p>
    </section>
  </section>
);
